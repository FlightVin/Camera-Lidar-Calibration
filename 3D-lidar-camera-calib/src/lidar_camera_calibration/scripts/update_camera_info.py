...
if __name__ == '__main__':
    ...
    BAG_FILES_PATH = "/media/gnani-u/IIITH-DATA/YEAR_3/Sem-1/MR/Project/Hail_Mary_ws/src/lidar_camera_calibration/bagfiles/"
    CAM_CALIB_PATH = "/media/gnani-u/IIITH-DATA/YEAR_3/Sem-1/MR/Project/Hail_Mary_ws/src/lidar_camera_calibration/"
    ...
    # Get parameters as arguments
        ...
        BAG_FILE = os.path.join(BAG_FILES_PATH, sys.argv[1])
        CALIB_FILE = os.path.join(CAM_CALIB_PATH, sys.argv[2])
